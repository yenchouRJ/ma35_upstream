					   ...
					   struct drm_atomic_commit *atomic_state)
{
	...
	if (dc->funcs->plane_enable)
		dc->funcs->plane_enable(dc, output);
}
					    ...
					    struct drm_atomic_commit *atomic_state)
{
	...
	if (dc->funcs->plane_disable)
		dc->funcs->plane_disable(dc, output);
}
					   ...
					   struct drm_atomic_commit *atomic_state)
{
	...
	if (dc->funcs->plane_update_ext)
		dc->funcs->plane_update_ext(dc, output, state);
}
