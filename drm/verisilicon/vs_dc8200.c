...
static void vs_dc8200_plane_enable(struct vs_dc *dc, unsigned int output)
{
	regmap_set_bits(dc->regs, VSDC_FB_CONFIG_EX(output),
...
static void vs_dc8200_plane_disable(struct vs_dc *dc, unsigned int output)
{
	regmap_set_bits(dc->regs, VSDC_FB_CONFIG_EX(output),
			VSDC_FB_CONFIG_EX_FB_EN);
...
static void vs_dc8200_plane_update_ext(struct vs_dc *dc, unsigned int output,
...
const struct vs_dc_funcs vs_dc8200_funcs = {
	...
	.plane_enable		= vs_dc8200_plane_enable,
	.plane_disable		= vs_dc8200_plane_disable,
	.plane_update_ext	= vs_dc8200_plane_update_ext,
